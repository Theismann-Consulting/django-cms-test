"""
Django settings for yx_test project.
...
SECRET_KEY = 'django-insecure-ka&7in$beo=-!oc)ipii503=@m+0%k^mfjh%1jon)wsh7qf$8f'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, "django-cms-yx-test", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    BASE_DIR / "django-cms-yx-test" / "static",
]
